...
const suspendUser = async (userId) => {
	try {
		...
		await db.User.update({ status: "suspended" }, { where: { id: userId } });
...
const activateUser = async (userId) => {
	try {
		...
		await db.User.update({ status: "active" }, { where: { id: userId } });
...
const blockPost = async (postId) => {
	try {
		...
		await db.Post.update({ isDeleted: true }, { where: { id: postId } });
...
const unblockPost = async (postId) => {
	try {
		...
		await db.Post.update({ isDeleted: false }, { where: { id: postId } });
